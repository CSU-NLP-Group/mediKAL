...
config_dict["result_log_pred_dir"] = f"/home/myjia/Medical_LLM_task/EMR_diagnos/output/1stinter/{config_dict['model_version']}_{config_dict['retriever_version']}_{config_dict['direct_topn']}/"

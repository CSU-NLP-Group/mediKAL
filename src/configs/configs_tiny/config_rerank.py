...
# 本次运行需要完成的任务列表
config_dict["task_list"] = [data_name.lower()]
# 上次运行终止的任务/科室/数据集
...
# 数据相关：输入数据的文件夹路径
config_dict["fin_directory"] = f"/home/myjia/Medical_LLM_task/EMR_diagnos/data/DSMD/{data_name}/1stinter/{config_dict['model_version']}_{config_dict['retriever_version']}_{config_dict['direct_topn']}/"
...
config_dict["result_log_pred_dir"] = f"/home/myjia/Medical_LLM_task/EMR_diagnos/data/DSMD/{data_name}/rerank/{config_dict['model_version']}_{config_dict['retriever_version']}_{config_dict['direct_topn']}/"
